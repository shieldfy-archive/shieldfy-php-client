...
use Shieldfy\Callbacks\PingCallback;
use Shieldfy\Callbacks\UpdateCallback;
use Shieldfy\Callbacks\VerifyCallback;
...
class CallbackHandler
{
    ...
    private function verify(){
        if(!isset($_SERVER['HTTP_X_SHIELDFY_CALLBACK_HASH'])) return false;
